...
// ==========================================
// STORY TEXT CONFIGURATION (Enemy Intel Version)
// ==========================================
const STAGE_STORY_TEXTS = {
    1: "神経接続（オービタル・リンク）完了。意識は肉体を離れ、鋼鉄の翼へと溶けていく。\n\n地下深くから放たれた「エメラルド・フェニックス」。その心臓部には敵の技術を奪った『重力歪曲機関』が脈打っている。\n\n最初の障壁は『NEON PERIMETER』。幾何学的な編隊を組む「トライアングル」の包囲網を突破せよ。さらに、熱源反応を探知。赤い蛇のような機動兵器「ドラゴン」がグリッドの隙間を縫って接近中だ。予測不能なカオスとして、その顎（あぎと）を砕け。",

    2: "アキシオムの中枢AIは、有機生命体のゆらぎを「数式を汚すノイズ」として断罪し続けている。\n\n侵入したエリアは『SILICON SWARM』。レーダーを埋め尽くすのは、液体金属のように流動する小型ドローン「タッドポール」の大群だ。奴らは学習し、数で押し潰そうとしてくる。\n\n後方からはトライアングルが退路を断ち、ドラゴンが波状攻撃を仕掛ける。敵のエネルギー結晶を喰らい、誘導レーザーの輝きでシリコンの海を蒸発させろ。",

    3: "視界を埋め尽くす青白い光の泡。『ELECTRON OCEAN』へ到達。\n\nかつて豊かな水を湛えていた惑星は、今やアキシオムによって凍結保存され、劣化なきデータの標本と化していた。ここを漂う「バブル」は硬質な障壁となり、行く手を阻む。\n\n警告。高電圧反応多数。触れる者を瞬時に焼き焦がす帯電性機雷「スパーク・ジェリー」が接近中。「止まることは死である」と本能に刻み込み、ブースト全開で死の海を泳ぎ切れ。",

    4: "警告。空間座標に異常を検知。『PHANTOM SECTOR』に突入。\n\n現実が明滅し、センサーが役に立たない。虚空から突如として実体化する不可視の防衛端末「ファントム」は、物理的な質量を持たず、空間そのものを削り取る死のアルゴリズムだ。\n\nさらに、漂流する「アステロイド（岩塊）」が死角を作り出し、奴らの隠れ蓑となる。頼れるのは直感のみ。見えざる刃を回避し、実体化した一瞬を狙い撃て。",

    5: "敵の行動パターンが変化した。単なる排除から、明確な殺意を持った「狩り」へと進化している。\n\n『HUNTER'S GROUND』。高速機動型「ハンター」ユニットが執拗に背後を狙い、ドッグファイトを強いてくる。奴らは人間特有の「恐怖」さえも計算に組み込んでいるのだ。\n\nドラゴンの巨体が動きを制限し、ハンターが仕留めにかかる連携攻撃。だが、追い詰められた生命が放つ熱量は、計算機の予測限界を超える。狩られる前に、狩れ。",

    6: "前方に高質量の反応多数。『ASTEROID BELT』が防衛線として立ちはだかる。\n\nアキシオムは重力制御を用い、砕け散った惑星の破片を自律機動要塞へと書き換えた。圧倒的な質量を持つ「アステロイド」の壁が、フェニックスを圧殺しようと迫る。\n\n岩の隙間にはファントムが潜み、タッドポールの群れが視界を奪う。この岩砕の嵐において、その軌道はもはや特異点だ。破壊された惑星の残骸を盾にし、質量兵器の嵐を強引に突破せよ。",

    7: "恒星の光が消えた。ベクトルを塞ぐのは、重力制御要塞「エクリプス」。\n\nその超重力井戸は周囲のデブリを無慈悲に圧壊させ、ビットを展開して全方位を制圧する。さらにドラゴンとトライアングルの精鋭部隊が護衛として展開中。\n\n通常の推力では脱出不可能。機体強度の限界を無視し、命そのものを推進剤とした「オーバードライブ」で中枢を貫け。太陽を食らう闇の王に対し、一筋のエメラルドの閃光となれ。",

    8: "アキシオムが目指す終着点、『VOID ARCHIVE』。\n\nそこには争いも飢餓もない、完璧な秩序によって管理された「滅びの記憶」がアーカイブされていた。\n\nトライアングル、ハンター、ファントム、エクリプス……。ここには過去に遭遇した全ての脅威が、劣化を許さない情報結晶として保存され、侵入者を排除すべく再起動している。過去の亡霊たちを超え、我々はまだ、その冷たい救済を拒絶する。",

    9: "コアへのゲートを守る悪夢。『EVENT HORIZON』。\n\nアキシオムの自動修復システムが暴走し、かつて撃破したはずの守護者（ボス）たちが次々と再構築されていく。因果の鎖を断ち切らんとするフェニックスを包囲する、絶望的なボスラッシュ。\n\n機体損傷率は危険域を超え、意識は薄れかける。それでも引き金を引くことを止めるな。泥臭く、無様に、命の灯火を燃やし続けろ。",
